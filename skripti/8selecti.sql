...
where dr2.Lietotājs2 in (select ws.Lietotājs2 from Draudzējas ws where ws.Lietotājs1 = dr1.Lietotājs1)
...
-- Kāda žanra spēles izstrādātājs izstrādā
...
-- Izstrādātāja žanrs ar visvairāk spēlēm
select *
from (
...
SELECT
	...
	sli.*,
	lag(Lietotāji) over (partition by Izstrādātājs.Nosaukums order by Lietotāji)
FROM Izstrādātājs
LEFT JOIN Spēle on Spēle.Izstrādātājs = Izstrādātājs.Nosaukums
...
-- Lietotāja inventārs pēc spēlēm
SELECT
	Lietotājs.ID,
	Lietotājs.Niks,
	Spēle.ID SpēleID,
